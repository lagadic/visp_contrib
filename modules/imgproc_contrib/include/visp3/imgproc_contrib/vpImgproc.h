...
#include <visp3/imgproc_contrib/vpContours.h>
...
VISP_EXPORT void unsharpMask(vpImage<unsigned char> &I, float sigma = 2.0f, const double weight = 0.6);
VISP_EXPORT void unsharpMask(const vpImage<unsigned char> &I, vpImage<unsigned char> &Ires,
                             float sigma = 2.0f, const double weight = 0.6);
VISP_EXPORT void unsharpMask(vpImage<vpRGBa> &I, float sigma = 2.0f, const double weight = 0.6);
