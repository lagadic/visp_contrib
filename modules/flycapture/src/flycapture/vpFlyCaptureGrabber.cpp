...
/*!
  ...
  \param gain_value : The amount of amplification that is applied to a pixel in manual mode. An increase in
  gain can result in an increase in noise.
...
/*!
  ...
  brightness applying \e brightness_value parameter.
  \param brightness_value : This is the level of black in an image. A high brightness will result in a low
...
/*!
  ...
  sharpness applying \e sharpness_value parameter.
  \param sharpness_value :
  Parameter used to tune the filter applied on the image to reduce blurred edges
  in an image.
